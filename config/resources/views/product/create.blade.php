                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" placeholder="{{ __('Enter Your Product Name') }}" id="title" name="title" value="{{ old('title') }}" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('quantity') is-invalid @enderror" placeholder="{{ __('Enter Your Product Quantity') }}" id="quantity" name="quantity" value="{{ old('quantity') }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control @error('price') is-invalid @enderror" placeholder="{{ __('Price Of Your Product ') }}" id="price" name="price" value="{{ old('price') }}" required>
